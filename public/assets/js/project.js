...
//displays Venue info into table
            ...
            $.post("/api/venue", userData, function(data) {
              ...
              for(var i = 0; i < data.length; i++) {
                ...
                console.log(data[i].url);
                $("#venue-data").append(`<tr><td>${data[i].name}</td><td>${data[i].dates.start.localDate}</td><td>${data[i].classifications[0].genre.name}</td><td><a href="${data[i].url}">${data[i].url}</a></td></tr>`);
              }
...
//displays location info into table
            ...
            $.post("/api/location", userData, function(data) {
                ...
                console.log(data[i]._embedded.venues[0].name);
                console.log(data[i].url);
                $("#location-data").append(`<tr><td>${data[i].dates.start.localDate}</td><td>${data[i].name}</td><td>${data[i]._embedded.venues[0].name}</td><td><a href="${data[i].url}">${data[i].url}</a></td></tr>`)
                }
